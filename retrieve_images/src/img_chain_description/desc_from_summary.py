...
from img_chain_description.prompt_gen_abstract import ABSTRACT_PROMPT, SYSTEM_PROMPT
NUM_TOPIC = 2
...
IMAGE_SOURCE_PATHS: List[str] = [
    '/research/d7/fyp24/tpipatpajong2/graphRAG_multimodal/dataset/stanford40',
]
