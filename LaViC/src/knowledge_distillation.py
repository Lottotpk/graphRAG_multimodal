...
class PretrainVisionModel(pl.LightningModule):
    ...
    def forward(self, input_ids, attention_mask, images, image_token_mask, labels=None):
        ...
        # Get language embeddings for all tokens
...
def main():
    ...
    trainer = pl.Trainer(
        ...
        devices=-1,
        strategy="ddp", # Allow parallel computation
    ...
    trainer.fit(pl_model, train_loader, val_loader, ckpt_path="./out_distilled/pretrain_epochepoch=2-val_lossval_loss=1.3652.ckpt")
