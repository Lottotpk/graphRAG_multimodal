...
def main():
    ...
    args.train_data_path = f"../data/{args.category}/train2.jsonl"
    args.val_data_path = f"../data/{args.category}/valid2.jsonl"
    args.test_data_path = f"../data/{args.category}/test2.jsonl"
    ...
    model_key = ""
    if args.candidate_type == 'candidates_st':
        model_key = "st" 
    elif args.candidate_type == 'candidates_gpt_large':
        model_key = "gpt_large"
    else:
        model_key = "qwen"
